    ...
    public partial class BlackAndWhiteForm : Form
    {
        ...
        private void SetStatusLabelField(object sender, EventArgs e)
        {
            if (sender is Button button)
            {
                ...
                {
                    case "Black":
                        stringBuilder.Append(value: Localization.colorNameBlack);
                        break;
                    case "White":
                        stringBuilder.Append(value: Localization.colorNameWhite);
                        break;
                    default:
            ...
            ushort[] centeredField)
        {
            ...
            {
                ushort[] combinedNeightbourFields = linearNeightbourFields.Union(second: diagonalNeightbourFields)
                    .ToArray();
